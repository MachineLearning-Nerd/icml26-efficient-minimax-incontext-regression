...
- Code: [`repro/claims/c4_param_count.py`](https://github.com/MachineLearning-Nerd/icml26-efficient-minimax-incontext-regression/blob/main/repro/claims/c4_param_count.py)
